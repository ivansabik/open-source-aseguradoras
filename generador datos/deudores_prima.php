...
$deudores = array();
file_put_contents("deudores_prima.csv", "nivel_1|nivel_2|nivel_3|nivel_4|moneda|consecutivo|afectación|referencia_regimen|operacion|cve_ramo|primas_por_cobrar_total|recargos|impuestos|derechos_poliza|comi_x_dev|recargos_dev|derechos_poliza_dev|primas_por_cobrar|;" . PHP_EOL);
foreach (range(1, NUM_REGISTROS) as $deudor) {
    ...
    file_put_contents("deudores_prima.csv", $deudor, FILE_APPEND);
    print $deudor;
}
